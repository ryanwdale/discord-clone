...
class LoginResource(Resource):
    def post(self):
        ...
        if user is None:
            return abort(
                404,
                message="There is no account associated with that username. Please try again.",
            )
        ...
        return abort(
            403,
            message="The password you’ve entered is incorrect or you have inputted an incorrect username. Please try again.",
        )
